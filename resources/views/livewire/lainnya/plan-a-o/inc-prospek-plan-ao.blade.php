<div class="table-responsive table-responsive-md" id="table-container">
    <table class="table table-striped table-hover table-sm" id="exportTableProspek">
        <thead class="table-primary">
            <tr>
                ...
                <th style="text-align: left; min-width: 170px;">Nama</th>
                <th style="text-align: left; min-width: 200px;">Alamat/Kec/Desa</th>
                <th style="text-align: left; min-width: 170px;">Jenis Usaha</th>
                <th style="text-align: left; min-width: 170px;">No Telp</th>
                <th style=" min-width: 50px;">Visit Ke</th>
...
{{ $monPro->onEachSide(1)->links('vendor.livewire.bootstrap', data: ['scrollTo' => false]) }}
