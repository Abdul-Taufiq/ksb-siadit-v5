...
<body>
    ...
    <p class="mt-3">
        ...
        {{ $pkpmk->id_cabang == 1 ? 'Kantor Pusat Operasional' : 'Kantor Cabang ' . ucfirst(strtolower($pkpmk->cabang->alamat)) }}
        untuk melakukan <b>blokir</b> atas
        <b>{{ strtoupper($depo->jns_jaminan) }}</b>, untuk keperluan fasilitas kredit sesuai dengan Perjanjian Kredit
    ...
    <p class="mt-3">
        Demikian permohonan ini kami sampaikan, selanjutnya atas pemblokiran rekening tersebut saya bersedia menerima
        dan taat pada ketentuan yang berlaku di PT BPR Kusuma Sumbing serta peraturan perundang-undangan yang berlaku.
    </p>
    ...
    <div style="page-break-inside: avoid">
        <div style="text-align: left;">
            ...
            {{ $pkpmk->tgl_print_blokir?->translatedFormat('d F Y') }}
        </div>
