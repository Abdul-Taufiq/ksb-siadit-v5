<div class="mb-2">
    <table class="table table-bordered table-sm w-100">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="vertical-align: top;">{!! $muk->putusan?->catatan_analis_cabang !!}</td>
            </tr>
            <tr>
                ...
                <td style="vertical-align: top;">{!! $muk->putusan?->catatan_ao !!}</td>
            </tr>
        </tbody>
    </table>
    ...
    @if (
        $muk->kredit->persetujuan->putusan == 'Area' ||
            ...
            ($muk->deviasi->perihal != '<p>-</p>' && $muk->deviasi->perihal != '-'))
        <table class="table table-bordered table-sm w-100">
            <thead>
                <tr>
            ...
            <tbody>
                <tr>
                    ...
                    <td style="vertical-align: top;">{!! $muk->putusan?->catatan_manajer_area !!}</td>
                </tr>
                <tr>
                    <td>2. Analis Area</td>
                    <td style="text-align: center">
                    ...
                    <td style="vertical-align: top;">{!! $muk->putusan?->catatan_analis_area !!}</td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: top;">{!! $muk->putusan?->catatan_analis_komite !!}</td>
                </tr>
            </tbody>
        </table>
    @endif
        ...
        <table class="table table-bordered table-sm w-100">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="vertical-align: top;">{!! $muk->putusan?->catatan_direktur_utama !!}</td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: top;">{!! $muk->putusan?->catatan_direktur_komersial !!}</td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: top;">{!! $muk->putusan?->catatan_analis_pst !!}</td>
                </tr>
            </tbody>
        </table>
    @endif
