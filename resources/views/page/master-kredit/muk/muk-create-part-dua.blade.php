        ...
        <div class="container" style="margin-top: -10px">
            ...
            <div class="stat-cards-item">
                <div class="card-header mb-2">
                    ...
                    <strong><i>Progress 2/4</i></strong><br>
                    <i>Note: Nomor MUK dan Tanggal MUK otomatis oleh sistem</i>
                </div>
                <div class="card-body w-100">

                    {{-- data debitur --}}
                    <form id="quickForm" action="{{ route('muk.store.partdua') }}" method="POST"
                        ...
                        <input type="hidden" id="metode" name="metode"
                            value="{{ !empty($muk->deviasi) ? 'Edit' : null }}" readonly>
                        ...
                        <div class="card mb-2">
                            <div class="card-header bg-primary text-white">
                                <div class="d-flex justify-content-between" onclick="hideForm2()">
                                    <div class="head-judul">1. DATA MANAGEMENT</div>
                                    <i class="fa fa-eye" aria-hidden="true" id="show2"></i>
                                </div>
                            </div>
                            <div class="card-body" id="konten2">
                                @include('page.master-kredit.muk.input.data-management')
                            </div>
                        </div>
                        ...
                        <div class="card mb-2">
                            <div class="card-header bg-primary text-white">
                                <div class="d-flex justify-content-between" onclick="hideForm3()">
                                    <div class="head-judul">2. ANALISA INDUSTRI</div>
                                    <i class="fa fa-eye" aria-hidden="true" id="show3"></i>
                                </div>
                            </div>
                            <div class="card-body" id="konten3">
                                @include('page.master-kredit.muk.input.analisa-industri')
                            </div>
                        </div>
                        ...
                        <div class="card mb-2">
                            <div class="card-header bg-primary text-white">
                                <div class="d-flex justify-content-between" onclick="hideForm4()">
                                    <div class="head-judul">3. PENYIMPANGAN / DEVIASI</div>
                                    <i class="fa fa-eye" aria-hidden="true" id="show4"></i>
                                </div>
                            </div>
                            <div class="card-body" id="konten4">
                                @include('page.master-kredit.muk.input.penyimpangan-deviasi')
                            </div>
                        </div>
...
@section('script')
    ...
    <script src="{{ asset('script/master-kredit/muk/industri-flex.js') }}"></script>
    <script src="{{ asset('script/master-kredit/muk/deviasi-flex.js') }}"></script>
