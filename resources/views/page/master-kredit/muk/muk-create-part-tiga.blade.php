        ...
        <div class="container" style="margin-top: -10px">
            ...
            <div class="stat-cards-item">
                <div class="card-header mb-2">
                    ...
                    <strong><i>Progress 3/4</i></strong><br>
                    <i>Note: Nomor MUK dan Tanggal MUK otomatis oleh sistem</i>
                </div>
                <div class="card-body w-100">

                    {{-- data debitur --}}
                    <form id="quickForm" action="{{ route('muk.store.parttiga') }}" method="POST"
                        ...
                        <div class="card mb-2">
                            <div class="card-header bg-primary text-white">
                                <div class="d-flex justify-content-between" onclick="hideForm2()">
                                    <div class="head-judul">1. AGUNAN</div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        @if ($metode != null)
                                            <a href="{{ route('muk.add.partempat', $metode) }}"
