<div class="col-md-6 mb-3">
    <div class="form-group">
        ...
        <input type="text" name="tujuan_penilaian_{{ $loop->iteration }}" id="tujuan_penilaian_{{ $loop->iteration }}"
            ...
            value="{{ data_get($kenda, "$vanalisSCKenda.tujuan_penilaian") ?? (data_get($kenda, "$vcabSCKenda.tujuan_penilaian") ?? 'Permohonan Baru') }}">
    </div>
</div>
                ...
                <td>
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" name="d1_harga_{{ $loop->iteration }}"
                            ...
                            value="{{ number_format(data_get($kenda, "$vanalisSCKenda.d1_harga") ?? data_get($kenda, "$vcabSCKenda.d1_harga"), 0, ',', '.') }}">
                    </div>
                </td>
                <td>
                    <input type="text" name="d1_instansi_{{ $loop->iteration }}"
                        ...
                        value="{{ data_get($kenda, "$vanalisSCKenda.d1_instansi") ?? data_get($kenda, "$vcabSCKenda.d1_instansi") }}">
                </td>
                <td>
                    <input type="text" name="d1_alamat_{{ $loop->iteration }}"
                        id="d1_alamat_{{ $loop->iteration }}" class="form-control form-control-sm" required
                        value="{{ data_get($kenda, "$vanalisSCKenda.d1_alamat") ?? data_get($kenda, "$vcabSCKenda.d1_alamat") }}">
                </td>
                <td>
                    <input type="date" name="d1_tgl_{{ $loop->iteration }}" id="d1_tgl_{{ $loop->iteration }}"
                        class="form-control form-control-sm" required
                        value="{{ optional(data_get($kenda, "$vanalisSCKenda.d1_tgl"))->format('Y-m-d') ?? optional(data_get($kenda, "$vcabSCKenda.d1_tgl"))->format('Y-m-d') }}">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" name="d2_harga_{{ $loop->iteration }}"
                            ...
                            min="0"
                            value="{{ number_format(data_get($kenda, "$vanalisSCKenda.d2_harga") ?? data_get($kenda, "$vcabSCKenda.d2_harga"), 0, ',', '.') }}">
                    </div>
                </td>
                <td>
                    <input type="text" name="d2_instansi_{{ $loop->iteration }}"
                        ...
                        value="{{ data_get($kenda, "$vanalisSCKenda.d2_instansi") ?? data_get($kenda, "$vcabSCKenda.d2_instansi") }}">
                </td>
                <td>
                    <input type="text" name="d2_alamat_{{ $loop->iteration }}"
                        id="d2_alamat_{{ $loop->iteration }}" class="form-control form-control-sm" required
                        value="{{ data_get($kenda, "$vanalisSCKenda.d2_alamat") ?? data_get($kenda, "$vcabSCKenda.d2_alamat") }}">
                </td>
                <td>
                    <input type="date" name="d2_tgl_{{ $loop->iteration }}" id="d2_tgl_{{ $loop->iteration }}"
                        class="form-control form-control-sm" required
                        value="{{ optional(data_get($kenda, "$vanalisSCKenda.d2_tgl"))->format('Y-m-d') ?? optional(data_get($kenda, "$vcabSCKenda.d2_tgl"))->format('Y-m-d') }}">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" name="d3_harga_{{ $loop->iteration }}"
                            ...
                            value="{{ number_format(data_get($kenda, "$vanalisSCKenda.d3_harga") ?? data_get($kenda, "$vcabSCKenda.d3_harga"), 0, ',', '.') }}">
                    </div>
                </td>
                <td>
                    <input type="text" name="d3_instansi_{{ $loop->iteration }}"
                        ...
                        value="{{ data_get($kenda, "$vanalisSCKenda.d3_instansi") ?? data_get($kenda, "$vcabSCKenda.d3_instansi") }}">
                </td>
                <td>
                    <input type="text" name="d3_alamat_{{ $loop->iteration }}"
                        id="d3_alamat_{{ $loop->iteration }}" class="form-control form-control-sm" required
                        value="{{ data_get($kenda, "$vanalisSCKenda.d3_alamat") ?? data_get($kenda, "$vcabSCKenda.d3_alamat") }}">
                </td>
                <td>
                    <input type="date" name="d3_tgl_{{ $loop->iteration }}" id="d3_tgl_{{ $loop->iteration }}"
                        class="form-control form-control-sm" required
                        value="{{ optional(data_get($kenda, "$vanalisSCKenda.d3_tgl"))->format('Y-m-d') ?? optional(data_get($kenda, "$vcabSCKenda.d3_tgl"))->format('Y-m-d') }}">
                </td>
            </tr>
        </tbody>
    </table>
            ...
            <td>
                <div class="input-group input-group-sm">
                    ...
                    <input type="text" name="harga_pasar_keseluruhan_{{ $loop->iteration }}"
                        ...
                        value="{{ number_format(data_get($kenda, "$vanalisSCKenda.harga_pasar_keseluruhan") ?? data_get($kenda, "$vcabSCKenda.harga_pasar_keseluruhan"), 0, ',', '.') }}">
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="input-group input-group-sm">
                    <input type="number" name="safety_margin_kenda_{{ $loop->iteration }}"
                        ...
                        min="0"
                        value="{{ number_format(data_get($kenda, "$vanalisSCKenda.safety_margin") ?? data_get($kenda, "$vcabSCKenda.safety_margin"), 0, ',', '.') ?? '50' }}">
            ...
            <td>
                <input type="number" name="score_kenda_{{ $loop->iteration }}"
                    ...
                    value="{{ number_format(data_get($kenda, "$vanalisSCKenda.score") ?? data_get($kenda, "$vcabSCKenda.score"), 0, ',', '.') }}">
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <div class="input-group input-group-sm">
                    ...
                    <input type="text" name="harga_pasar_diterima_{{ $loop->iteration }}"
                        ...
                        readonly
                        value="{{ number_format(data_get($kenda, "$vanalisSCKenda.harga_pasar_diterima") ?? data_get($kenda, "$vcabSCKenda.harga_pasar_diterima"), 0, ',', '.') }}">
                </div>
            </td>
        </tr>
    </table>
