function penagiahanFunc(getSheet, cabang, nama_ao, tgl) {
    // --- Judul utama ---
    getSheet.mergeCells("A1:J1");
    ...
    getSheet.getCell("E5").value = "Nama Debitur";
    getSheet.getCell("F5").value = "Jenis Kegiatan";
    getSheet.getCell("G5").value = "Baki Debet";
    getSheet.getCell("H5").value = "Total Tagihan";
    getSheet.getCell("I5").value = "ASR Ke";
    getSheet.getCell("J5").value = "Keterangan";
    ...
    // --- Isi data dari tbody ---
    const tablegetSheet = document.getElementById("exportTablePenagihan");
