...
const bjk_disposible_income = document.getElementById("bjk_disposible_income");
function updateKewajibanAkhirBjk() {
    ...
    let total = sisa - angsuran - bunga;

    bjk_disposible_income.value = setFormatRupiah(total);
    bjk_disposible_income.classList.remove("is-invalid");
    bjk_disposible_income.classList.add("is-valid");
