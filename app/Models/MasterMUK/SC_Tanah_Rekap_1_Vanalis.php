...
class SC_Tanah_Rekap_1_Vanalis extends Model
{
    use HasFactory;
    protected $connection = 'mysql';
    protected $table = 'tb_muk_sc_tanah_rekap_1_vanalis';
    protected $primaryKey = 'id_sc_rekap_1';
    protected $guarded = ['id_sc_rekap_1'];
