...
class SC_Tanah_Scoring_Vanalis extends Model
{
    use HasFactory;
    protected $connection = 'mysql';
    protected $table = 'tb_muk_sc_tanah_scoring_vanalis';
    protected $primaryKey = 'id_sc_scoring';
    protected $guarded = ['id_sc_scoring'];
