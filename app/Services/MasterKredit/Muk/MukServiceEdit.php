...
class MukServiceEdit
{
    ...
    public function editPartSatu($data)
    {
        ...
        if ($data['jns_kredit'] == 'Angsuran') {
            $angsuran = MukKeuangan::where('id_muk', $id_muk)->first();
            // jika tak kosong
            if ($angsuran) {
                $angsuran->update([
                    'id_muk' => $id_muk,
                ...
                MukKeuanganBjk::where('id_muk', $id_muk)->delete();
            ...
            $bjk = MukKeuanganBjk::where('id_muk', $id_muk)->first();
            // jika tak kosong
            if ($bjk) {
                $bjk->update([
                    'id_muk' => $id_muk,
                ...
                MukKeuangan::where('id_muk', $id_muk)->delete();
    ...
    public function editTanah($data)
    {
        ...
        for ($i = 1; $i < 201; $i++) {
            if (!empty($data['nama_deb_' . $i])) {
                ...
                if (isset($data['data_1_' . $i]) && $data['data_1_' . $i] !== '' && !isset($data['bangunan_luas_1_' . $i])) {
                    $jamTanah->update([
